    ...
    private void runRound(Board board) {
        ...
        while (!playerQueue.isEmpty()) {
            ...
            if (currentPlayer.isInJail()) {
                System.out.println();
                System.out.println();
                currentPlayer.handleJailInteraction(new Jail());
            }
            if (currentPlayer.isBankrupt()) {
